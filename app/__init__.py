...
def state(state_name):
    ...
    locations = get_list_of_locations_by_state(state_name)

    return render_template("state.html", login_status=logged_in, username=session_username, stats=stats, locations=locations)
